...
### Changed
- **Receipt reject endpoint** — Changed HTTP method from `POST` to `DELETE` for `POST /v1/receipts/{id}/reject`
- Removed `ReceiptRejectRequest` request body from receipt reject endpoint
